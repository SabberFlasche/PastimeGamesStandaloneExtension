...
public class Connect4 implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        try {
            ...
            if (Bukkit.getOnlinePlayers().contains(Bukkit.getPlayer(args[0]))) {
                ...
                if (RequestManager.addConnect4Request(player1, player2)) {
    ...
    public void sendMessage(Player p, Player requester) {
        TextComponent message = new TextComponent( ChatColor.GRAY + requester.getDisplayName() + " wants to play Connect4 with you: " );
